    ...
    <Container maxWidth="sm">
      ...
      >
        ...
        <DialogContent>
          <CreateNoteForm
            centerId={centerId}
            closeModal={isModalOpen.setFalse}
          />
        </DialogContent>
        <DialogActions>
        ...
        {notesContext.list.map((note: any) => (
          <StyledCard key={note.id}>
            <CardContent style={{ position: "relative" }}>
              ...
              />
              <StyledChip
                avatar={<Avatar>{note.nbStoredDocs}</Avatar>}
                label="Documents stockés"
              />
              <Typography variant="subtitle1">
                Remarques concernant les bénéficiaires
              </Typography>
              <Typography variant="body2" component="p">
                {note.beneficiariesNotes}
              </Typography>
              <Typography variant="subtitle1">
                Remarques concernant les professionnels
              </Typography>
              <Typography variant="body2" component="p">
                {note.proNotes}
              </Typography>
              <Typography variant="subtitle1">
                Remarques concernant Reconnect
              </Typography>
              <Typography variant="body2" component="p">
                {note.reconnectNotes}
              </Typography>

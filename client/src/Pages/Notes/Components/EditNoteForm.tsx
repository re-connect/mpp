...
const EditNoteForm: any = withRouter(
  ({ history, centerId, closeModal, note }: any) => {
    ...
    const update = (note: NoteInterface) => {
      ...
      if (token !== null) {
        ...
        alert(
          "Il semble que vous ne soyez pas connecté, veuillex vous reconnecter"
        );
        history.push("/login");
      }
    };
            ...
            return (
              <StyledForm onSubmit={props.handleSubmit}>
                ...
                <TextField
                  ...
                  onChange={props.handleChange}
                />
                {props.errors.proNotes && (
                  <div id="feedback">{props.errors.proNotes}</div>
                )}
                <TextField
                  id="reconnect-notes"
                  name="reconnectNotes"

...
#[ApiResource(shortName: 'notes', security: 'is_granted(\'ROLE_USER\')', order: ['date' => 'DESC'], denormalizationContext: ['groups' => ['permanence:write']], normalizationContext: ['groups' => ['permanence:read']])]
#[ORM\Table(name: 'note')]
#[ORM\Entity]

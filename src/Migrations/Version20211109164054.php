 ...
 */
final class Version20211109164054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE center ADD permanence BOOLEAN DEFAULT \'true\'');
        $this->addSql('ALTER TABLE center ADD workshop BOOLEAN DEFAULT \'false\'');
    }

 ...
 */
final class Version20190919075927 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note ADD person_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_CFBDFA14217BBB47 ON note');
        $this->addSql('ALTER TABLE note DROP person_id');
    }
}
